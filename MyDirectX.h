...
extern int Num_Layout_lines;
extern int Num_Message_lines;
extern int Num_Resource_lines;

extern string Layout_Array[50][10];
extern string Message_Array[1000][20];
extern string Stat_Array[50][5];
